...
const productValidationSchema = Yup.object().shape(
    {
        name: Yup.string()
            ...
            .max(20, 'Name must be less then 20 symbols')
                    ...
                    {props => (
                        <Form>
                            <Stack spacing={2} direction="column">
                                ...
                                <Typography
                                    variant="h5">{productId ? 'Update Product:' : 'Create Product:'}</Typography>
                            ...
                            <Typography sx={{textAlign: 'right', mt: 2}}>
                                {
                                    props.isSubmitting ? <CircularProgress/> : <Button variant="outlined"
                                                                                       type="submit">{productId ? 'Update' : 'Create'}</Button>
                                }
                            </Typography>
                        </Form>
                    )
